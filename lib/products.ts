...
export const products: Product[] = [
  {
    ...
    gallery: [
      "/images/camarotes/camarote-metalico-negro-real.jpg",
      "/images/camarotes/camarote-metalico-hogar-moderno.jpg",
      "/images/camarotes/camarote-metalico-juvenil.jpg",
      "/images/camarotes/camarote-metalico-pieza-arriendo.jpg",
      "/images/camarotes/camarote-metalico-premium.jpg",
    ],
    badge: "Más robusto",
    popular: true,
...

  {
    ...
    gallery: [
      "/images/camarotes/camarote-petalo-fondo-blanco.jpg",
      "/images/camarotes/camarote-petalo-premium.jpg",
      "/images/camarotes/camarote-petalo-nordico.jpg",
      "/images/camarotes/camarote-petalo-juvenil-led.jpg",
      "/images/camarotes/camarote-petalo-dormitorio-hermanas.jpg",
      "/images/camarotes/camarote-petalo-habitacion-nina.jpg",
      "/images/camarotes/camarote-petalo-infantil-celeste.jpg",
    ],
...

  {
    ...
    addOns: [parrillaEstandar, baranda, cambioMedida],
    emoji: "🪜",
    imgSrc: "/images/camarotes/camarote-metalico-habitacion-pequena.jpg",
    imgAlt: "Cama alta metálica con espacio libre abajo",
    gallery: [
      "/images/camarotes/camarote-metalico-nordico.jpg",
      "/images/camarotes/camarote-metalico-ai.jpg",
    ],
...

  {
    ...
    gallery: [
      "/images/camarotes/camarote-petalo-dormitorio-hermanas.jpg",
      "/images/camarotes/camarote-metalico-dormitorio-compartido.jpg",
      "/images/camarotes/camarote-metalico-premium.jpg",
    ],
    badge: "Más cómodo",
...

  {
    ...
    gallery: [
      "/images/camarotes/camarote-petalo-nido-dormitorio-moderno.jpg",
      "/images/camarotes/camarote-petalo-nido-blanco-premium.jpg",
      "/images/camarotes/camarote-petalo-nido-juvenil-led.jpg",
      "/images/camarotes/camarote-petalo-nido-real-fabrica.jpg",
      "/images/camarotes/camarote-petalo-nido-habitacion-nina.jpg",
      "/images/camarotes/camarote-nido-infantil-celeste.jpg",
      "/images/camarotes/camarote-nido-pieza-compartida-hermanas.jpg",
      "/images/camarotes/camarote-metalico-nido-estilo-nordico.jpg",
    ],
    badge: "3 en 1",
...

  {
    ...
    gallery: [
      "/images/camarotes/camarote-triple-litera-real.jpg",
      "/images/camarotes/camarote-triple-metalico-real.jpg",
      "/images/camarotes/camarote-triple-dormitorio-hostal.jpg",
      "/images/camarotes/camarote-triple-dormitorio-multiple.jpg",
      "/images/camarotes/camarote-triple-ai.jpg",
    ],
    badge: "3 niveles",
...

  {
    ...
    imgAlt: "Camarote con escritorio — cama arriba escritorio abajo",
    gallery: [
      "/images/camarotes/camarote-escritorio-2-plazas-full-real.jpg",
      "/images/camarotes/camarote-escritorio-2-plazas-dormitorio-completo.jpg",
      "/images/camarotes/camarote-escritorio-2-plazas-juvenil.jpg",
      "/images/camarotes/camarote-escritorio-2-plazas-gamer.jpg",
      "/images/camarotes/camarote-escritorio-2-plazas-universitario.jpg",
      "/images/camarotes/camarote-escritorio-2-plazas-home-office.jpg",
      "/images/camarotes/camarote-escritorio-2-plazas-nordico.jpg",
      "/images/camarotes/camarote-escritorio-2-plazas-productividad.jpg",
    ],
...

  {
    ...
    gallery: [
      "/images/camarotes/camarote-con-escritorio-economico-real.jpg",
      "/images/camarotes/camarote-escritorio-economico-dormitorio.jpg",
      "/images/camarotes/camarote-escritorio-economico-estudio.jpg",
      "/images/camarotes/camarote-escritorio-economico-gamer.jpg",
      "/images/camarotes/camarote-escritorio-economico-universitario.jpg",
      "/images/camarotes/camarote-escritorio-economico-home-office.jpg",
      "/images/camarotes/camarote-escritorio-economico-pieza-pequena.jpg",
      "/images/camarotes/camarote-escritorio-economico-juvenil.jpg",
      "/images/camarotes/camarote-escritorio-economico-ai.jpg",
      "/images/camarotes/camarote-escritorio-economico-detalle.jpg",
    ],
    badge: "Más económico",
    seoKeywords: [
...

  {
    ...
    gallery: [
      "/images/camarotes/camarote-con-escritorio-full-real.jpg",
      "/images/camarotes/camarote-escritorio-full-negro.jpg",
      "/images/camarotes/camarote-escritorio-full-nordico.jpg",
      "/images/camarotes/camarote-escritorio-full-gamer.jpg",
      "/images/camarotes/camarote-escritorio-full-universitario.jpg",
      "/images/camarotes/camarote-escritorio-full-juvenil.jpg",
      "/images/camarotes/camarote-escritorio-full-dormitorio-completo.jpg",
      "/images/camarotes/camarote-escritorio-full-detalle.jpg",
      "/images/camarotes/camarote-escritorio-full-productividad.jpg",
      "/images/camarotes/camarote-escritorio-full-ai.jpg",
    ],
    badge: "Premium",
    popular: true,
    seoKeywords: [
...

  {
    ...
    emoji: "🛏️",
    imgSrc: "/images/camarotes/camarote-metalico-negro-fondo-blanco.jpg",
    imgAlt: "Camarote 2 plazas abajo 1 plaza arriba estructura metálica",
    gallery: [
      "/images/camarotes/camarote-petalo-dormitorio-hermanas.jpg",
      "/images/camarotes/camarote-metalico-hogar-moderno.jpg",
      "/images/camarotes/camarote-metalico-premium.jpg",
...

  {
    ...
    gallery: [
      "/images/camarotes/camarote-desmontable-negro-real.jpg",
      "/images/camarotes/camarote-desmontable-metalico.jpg",
      "/images/camarotes/camarote-desmontable-litera-metalica.jpg",
      "/images/camarotes/camarote-desmontable-juvenil.jpg",
      "/images/camarotes/camarote-desmontable-pieza-adolescente.jpg",
      "/images/camarotes/camarote-desmontable-moderno.jpg",
      "/images/camarotes/camarote-desmontable-premium.jpg",
      "/images/camarotes/camarote-desmontable-dormitorio-compartido.jpg",
      "/images/camarotes/camarote-desmontable-usado-como-cama.jpg",
    ],
    badge: "Fácil montaje",
    seoKeywords: [
...

  {
    ...
    emoji: "📦",
    imgSrc: "/images/camarotes/cama-metalica-gris-pension-hospedaje.jpg",
    imgAlt: "Cama de 2 plazas con cajón de almacenamiento metálica",
    gallery: [
      "/images/camarotes/cama-metalica-gris-individual-institucional.jpg",
      "/images/camarotes/cama-institucional-gris-individual-y-camarote.jpg",
      "/images/camarotes/camas-institucionales-dormitorio-multiple.jpg",
      "/images/camarotes/dormitorio-institucional-camas-grises.jpg",
    ],
