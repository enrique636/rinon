...
export default function CercosPerimetralesLaPintanaPage() {
  return (
    <div className="py-12 px-4">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "¿Fabrican e instalan cercos perimetrales en La Pintana?", acceptedAnswer: { "@type": "Answer", text: "Sí. Fabricamos los cercos en nuestro taller en Santiago y realizamos la instalación en La Pintana. Cotizamos el mismo día — solo necesitamos los metros lineales, la altura y el tipo de uso (casa, condominio o industria)." } },
...
<div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Cercos Perimetrales en La Pintana — Sur de Santiago</h1>
          <p className="text-gray-500 text-lg max-w-2xl mb-6 leading-relaxed">Fabricamos e instalamos cercos perimetrales en La Pintana. Para casas usamos tubo estructural pintado al horno; para terrenos grandes, malla eslabonada con postes y tensores. Cotización sin costo.</p>
          <a href={wa("Hola, necesito cotizar cerco perimetral en La Pintana. Metros: [METROS] ml. Altura: [ALTURA] m. Uso: [CASA / CONDOMINIO]. Con portón: [SÍ / NO].")} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold px-8 py-4 rounded-full text-base transition-colors">Cotizar cerco perimetral</a>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          {[
            ...
            { href: "/rejas-metalicas-la-pintana", label: "Rejas La Pintana", desc: "Frontis y ventanas" },
            { href: "/pintura-electrostatica-la-pintana", label: "Pintura La Pintana", desc: "Acabado al horno" },
          ].map((l) => (
