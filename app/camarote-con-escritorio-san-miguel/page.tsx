...
export const metadata: Metadata = {
  title: "Camarote con Escritorio en San Miguel — Fabricación directa | Rinon.cl",
  description: "Camarote con escritorio con despacho a San Miguel. Modelos económico, estándar y full. Fabricación directa en Chile, pago contra entrega en Santiago RM.",
  keywords: ["camarote con escritorio San Miguel", "cama alta con escritorio San Miguel", "camarote escritorio San Miguel", "camarote con escritorio san miguel despacho"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-san-miguel" },
};
...
const FAQ = [
  {
    q: "¿Hacen despacho de camarotes con escritorio a San Miguel?",
    a: "Sí. Despachamos e instalamos camarotes con escritorio en San Miguel y en toda la Región Metropolitana. En Santiago RM el pago es contra entrega: pagas cuando el producto llega a tu domicilio."
  },
  {
    q: "¿Cuánto demora el despacho a San Miguel?",
  ...
  {
    q: "¿Tienen camarotes con escritorio en stock para San Miguel?",
    a: "Consulta disponibilidad actual directamente por WhatsApp y te confirmamos el modelo y el plazo para San Miguel."
  }
];

export default function CamaroteEscritorioSanMiguelPage() {
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a San Miguel. ¿Qué modelos tienen?");
  return (
    <div className="py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-1.5 text-sm text-green-700 font-medium mb-5">
          <span className="w-2 h-2 bg-green-500 rounded-full" /> Despacho a San Miguel · Pago contra entrega
        </div>

        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Camarote con escritorio con despacho a San Miguel</h1>

        <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mb-4">San Miguel es una comuna residencial con muchas familias donde el camarote con escritorio es ideal para aprovechar el espacio en dormitorios compartidos o de tamaño moderado.</p>
        <p className="text-gray-500 leading-relaxed max-w-2xl mb-8">
          Fabricamos en acero en nuestro propio taller y despachamos a San Miguel y sectores como Gran Avenida, El Llano, Lo Ovalle.
        ...
        <div className="my-6 rounded-2xl overflow-hidden shadow-sm max-w-xl">
          <img src="/images/camarotes/camarote-escritorio-2-plazas-productividad.jpg" alt="Camarote con escritorio con despacho a San Miguel, Región Metropolitana" className="w-full object-cover" loading="lazy" />
        </div>
        ...
        {/* FAQ */}
        <div className="mt-12">
          <h2 className="text-xl font-bold text-gray-900 mb-5">Preguntas frecuentes — San Miguel</h2>
        ...
        <div className="mt-12 bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Cotizar en San Miguel</h2>
