...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Antofagasta | Norte Chile",
  description: "Camarotes metálicos con escritorio con despacho a Antofagasta. Fabricante en Santiago, envío al norte. Modelos económico, full y a medida. Cotiza por WhatsApp.",
  keywords: ["camarote con escritorio antofagasta", "litera escritorio antofagasta", "cama alta escritorio antofagasta", "camarote metalico norte chile"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-antofagasta" },
};

export default function Page() {
  const ciudad = "Antofagasta";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Antofagasta.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y toda la II Región de Antofagasta vía transporte terrestre. Llegamos también a Calama, Mejillones y Tocopilla. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad}, en el norte de Chile, es de aproximadamente 5-10 días hábiles dependiendo del servicio de transporte disponible en tu zona.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-1.5 text-sm text-green-700 font-medium mb-5">
          <span className="w-2 h-2 bg-green-500 rounded-full" /> Despacho a {ciudad} · Despacho norte chile
        </div>
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Camarote con Escritorio en {ciudad}</h1>
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la II Región de Antofagasta. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas al norte del país. También atendemos Calama, Mejillones y Tocopilla. Tiempo estimado de entrega: 5-10 días hábiles.</p>
        ...
        <div className="space-y-4 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { icon: "💬", t: "Cotiza por WhatsApp", d: `Dinos tu modelo y dirección en ${ciudad}. Te confirmamos disponibilidad y costo de despacho al norte.` },
              { icon: "📦", t: "Empacamos y despachamos", d: "El camarote sale de nuestro taller en Santiago empacado para transporte. Se envía vía transporte terrestre al norte." },
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la II Región de Antofagasta (Calama, Mejillones, Tocopilla) vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
            { q: "¿Cuánto demora el envío?", a: `El tiempo de despacho a ${ciudad} es de aproximadamente 5-10 días hábiles.` },
