...
export default function CamarotesHuechuarabaPage() {
  ...
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes a en Huechuraba?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos camarotes metálicos a en Huechuraba. Para Santiago RM el despacho incluye instalación. Para regiones coordinamos transporte al cotizar — solo necesitamos la dirección." } },
...
<div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Camarotes con Despacho a Huechuraba</h1>
          <p className="text-gray-500 text-lg max-w-2xl mb-4">Entregamos e instalamos camarotes metálicos en Huechuraba. Pagas cuando llega el camarote instalado. Despacho {formatPrice(SITE_CONFIG.despacho.precio)} · instalación incluida.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          {topProducts.map(product => (
            ...
            <img src="/images/camarotes/camarote-desmontable-moderno.jpg" alt="Camarote desmontable moderno Huechuraba — fabricante directo" className="w-full object-cover" loading="lazy" />
          </div>
<a href={getProductWhatsAppUrl(product.nombre)} target="_blank" rel="noopener noreferrer" className="text-xs bg-[#25D366] text-white font-semibold rounded-lg px-3 py-1.5 hover:bg-[#1ebe5d] transition-colors">Consultar</a>
        ...
        <div className="bg-green-50 border border-green-200 rounded-2xl p-6 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Cotizar despacho a Huechuraba</h2>
          <p className="text-gray-600 text-sm mb-4">Pagas cuando llega instalado. Sin adelanto.</p>
          <WhatsAppButton message="Hola, quiero cotizar un camarote con despacho a Huechuraba." size="lg">Cotizar ahora</WhatsAppButton>
        </div>
      </div>
    </div>
  );
