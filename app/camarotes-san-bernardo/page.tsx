    ...
    <div className="py-12 px-4">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
          { "@type": "Question", name: "¿Despachan camarotes a San Bernardo?", acceptedAnswer: { "@type": "Answer", text: `Sí. El despacho a San Bernardo tiene un costo de ${formatPrice(SITE_CONFIG.despacho.precio)} e incluye instalación.` } },
        ],
      }) }} />
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-1.5 text-sm text-green-700 font-medium mb-4">
            <span className="w-2 h-2 bg-green-500 rounded-full" /> Despacho a San Bernardo — Pago contra entrega
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Camarotes con Despacho a San Bernardo</h1>
          <p className="text-gray-500 text-lg max-w-2xl">Entregamos e instalamos camarotes metálicos en San Bernardo. Pagas cuando llega el camarote instalado. Sin adelanto, sin riesgos.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          {[
            { icon: "📍", titulo: "Despacho a San Bernardo", desc: `Costo fijo ${formatPrice(SITE_CONFIG.despacho.precio)} · Instalación incluida` },
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Camarotes para familias del sur de Santiago</h2>
          <p className="text-gray-600 leading-relaxed mb-4">San Bernardo es una de las comunas del gran Santiago sur con mayor presencia de familias numerosas. La zona combina sectores residenciales con casas de patio donde el espacio de los dormitorios puede ser limitado para más de un hijo. Los camarotes metálicos son la solución más solicitada para optimizar el espacio en estas habitaciones.</p>
          <p className="text-gray-600 leading-relaxed">Cubrimos toda la comuna de San Bernardo, incluyendo sectores como El Peral, Santa Marta de Linderos, Lo Herrera y todos los sectores residenciales de la zona.</p>
        </div>
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Modelos disponibles para San Bernardo</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <img src="/images/camarotes/camarote-metalico-pieza-arriendo.jpg" alt="Camarote metálico San Bernardo — precio bajo fabricante directo" className="w-full object-cover" loading="lazy" />
          </div>
<a href={getProductWhatsAppUrl(product.nombre)} target="_blank" rel="noopener noreferrer" className="text-xs bg-[#25D366] text-white font-semibold rounded-lg px-3 py-1.5 hover:bg-[#1ebe5d] transition-colors">Consultar</a>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Preguntas sobre despacho a San Bernardo</h2>
          <div className="space-y-4">
            {[
              { q: "¿Despachan a toda la comuna de San Bernardo?", a: "Sí, cubrimos toda San Bernardo y comunas limítrofes como Puente Alto, La Pintana, El Bosque y Calera de Tango." },
              { q: `¿Cuánto cuesta el despacho a San Bernardo?`, a: `El costo es de ${formatPrice(SITE_CONFIG.despacho.precio)} fijo. Incluye traslado e instalación completa en tu domicilio.` },
              { q: "¿Puedo coordinar la entrega un sábado?", a: "Sí, atendemos sábados de 9 a 14 hrs. Para horarios fuera de eso, consúltanos por WhatsApp y evaluamos disponibilidad." },
            ].map(faq => (
        ...
        <div className="bg-green-50 border border-green-200 rounded-2xl p-6 md:p-8 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">¿Listo para cotizar en San Bernardo?</h2>
          ...
          <WhatsAppButton message="Hola, quiero cotizar un camarote con despacho a San Bernardo. ¿Qué modelos tienen?" size="lg">
            Cotizar despacho a San Bernardo
          </WhatsAppButton>
        </div>
      </div>
    </div>
