...
export default function CercosPerimetralesLoEspejoPage() {
  return (
    <div className="py-12 px-4">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "¿Fabrican e instalan cercos perimetrales en Lo Espejo?", acceptedAnswer: { "@type": "Answer", text: "Sí. Fabricamos los cercos en nuestro taller en Santiago y realizamos la instalación en Lo Espejo. Cotizamos el mismo día — solo necesitamos los metros lineales, la altura y el tipo de uso (casa, condominio o industria)." } },
...
<div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Cercos Perimetrales en Lo Espejo — Sur de Santiago</h1>
          <p className="text-gray-500 text-lg max-w-2xl mb-6 leading-relaxed">Fabricamos e instalamos cercos perimetrales en Lo Espejo para casas y condominios. Materiales en tubo estructural y malla eslabonada, con pintura electrostática al horno. Cotización el mismo día.</p>
          <a href={wa("Hola, necesito cotizar cerco perimetral en Lo Espejo. Metros: [METROS] ml. Altura: [ALTURA] m. Uso: [CASA / CONDOMINIO]. Con portón: [SÍ / NO].")} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold px-8 py-4 rounded-full text-base transition-colors">Cotizar cerco perimetral</a>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          {[
            { href: "/cercos-perimetrales-san-miguel", label: "Cercos San Miguel", desc: "Sur RM" },
            { href: "/cercos-perimetrales-la-pintana", label: "Cercos La Pintana", desc: "Sur RM" },
            { href: "/rejas-metalicas-lo-espejo", label: "Rejas Lo Espejo", desc: "Frontis y ventanas" },
