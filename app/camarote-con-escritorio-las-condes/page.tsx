...
export default function CamaroteEscritorioLasCondesPage() {
  ...
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes con escritorio a Las Condes?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos e instalamos camarotes con escritorio en Las Condes con un costo fijo que incluye instalación. Pagas cuando llega el producto a tu domicilio." } },
...
<div className="max-w-4xl mx-auto">
        ...
        <div className="bg-green-50 border border-green-200 rounded-2xl p-6 text-center">
          ...
          <div className="my-5 rounded-2xl overflow-hidden shadow-sm">
            <img src="/images/camarotes/camarote-escritorio-full-nordico.jpg" alt="Camarote con escritorio con despacho a Las Condes Santiago" className="w-full object-cover" loading="lazy" />
          </div>
