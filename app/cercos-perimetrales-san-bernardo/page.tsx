...
export default function CercosPerimetralesSanBernardoPage() {
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Fabrican e instalan cercos perimetrales en San Bernardo?", acceptedAnswer: { "@type": "Answer", text: "Sí. Fabricamos los cercos en nuestro taller en Santiago y realizamos la instalación en San Bernardo. Cotizamos el mismo día — solo necesitamos los metros lineales, la altura y el tipo de uso (casa, condominio o industria)." } },
