...
export const metadata: Metadata = {
  title: "Camarote con Escritorio en Recoleta — Fabricación directa | Rinon.cl",
  description: "Camarote con escritorio con despacho a Recoleta. Modelos económico, estándar y full. Fabricación directa en Chile, pago contra entrega en Santiago RM.",
  keywords: ["camarote con escritorio Recoleta", "cama alta con escritorio Recoleta", "camarote escritorio Recoleta", "camarote con escritorio recoleta despacho"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-recoleta" },
};
...
const FAQ = [
  {
    q: "¿Hacen despacho de camarotes con escritorio a Recoleta?",
    a: "Sí. Despachamos e instalamos camarotes con escritorio en Recoleta y en toda la Región Metropolitana. En Santiago RM el pago es contra entrega: pagas cuando el producto llega a tu domicilio."
  },
  {
    q: "¿Cuánto demora el despacho a Recoleta?",
  ...
  {
    q: "¿Tienen camarotes con escritorio en stock para Recoleta?",
    a: "Consulta disponibilidad actual directamente por WhatsApp y te confirmamos el modelo y el plazo para Recoleta."
  }
];

export default function CamaroteEscritorioRecoletaPage() {
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Recoleta. ¿Qué modelos tienen?");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Recoleta", item: "https://rinon.cl/camarote-con-escritorio-recoleta" },
        ],
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-1.5 text-sm text-green-700 font-medium mb-5">
          <span className="w-2 h-2 bg-green-500 rounded-full" /> Despacho a Recoleta · Pago contra entrega
        </div>

        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Camarote con escritorio con despacho a Recoleta</h1>

        <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mb-4">Recoleta tiene muchos departamentos de tamaño moderado y casas antiguas donde los camarotes con escritorio resuelven el problema del espacio limitado.</p>
        <p className="text-gray-500 leading-relaxed max-w-2xl mb-8">
          Fabricamos en acero en nuestro propio taller y despachamos a Recoleta y sectores como Cementerio General, Dominica, Avenida Recoleta.
        ...
        <div className="my-6 rounded-2xl overflow-hidden shadow-sm max-w-xl">
          <img src="/images/camarotes/camarote-escritorio-2-plazas-productividad.jpg" alt="Camarote con escritorio con despacho a Recoleta, Región Metropolitana" className="w-full object-cover" loading="lazy" />
        </div>
        ...
        {/* FAQ */}
        <div className="mt-12">
          <h2 className="text-xl font-bold text-gray-900 mb-5">Preguntas frecuentes — Recoleta</h2>
        ...
        <div className="mt-12 bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Cotizar en Recoleta</h2>
