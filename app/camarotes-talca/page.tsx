...
export default function CamarotesTalcaPage() {
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes a en Talca?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos camarotes metálicos a en Talca. Para Santiago RM el despacho incluye instalación. Para regiones coordinamos transporte al cotizar — solo necesitamos la dirección." } },
