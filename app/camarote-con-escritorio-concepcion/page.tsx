...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Concepción | Biobío",
  description: "Camarotes metálicos con escritorio con despacho a Concepción y el Gran Concepción. Fabricante en Santiago, envío a la Región del Biobío. Cotiza hoy.",
  keywords: ["camarote con escritorio concepcion", "litera escritorio concepcion", "cama alta escritorio concepcion", "camarote biobio escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-concepcion" },
};

export default function Page() {
  const ciudad = "Concepción";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Concepción.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y el Gran Concepción (Talcahuano, Chiguayante, San Pedro de la Paz) en la Región del Biobío vía transporte terrestre. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad} es de aproximadamente 5-10 días hábiles dependiendo del servicio de transporte disponible en tu zona.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la VIII Región del Biobío. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas. Cubrimos el Gran Concepción: Talcahuano, Chiguayante y San Pedro de la Paz. Tiempo estimado de entrega: 5-10 días hábiles.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y el Gran Concepción (Talcahuano, Chiguayante, San Pedro de la Paz) vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
