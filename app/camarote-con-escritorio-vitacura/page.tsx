...
export const metadata: Metadata = {
  title: "Camarote con Escritorio en Vitacura — Fabricación directa | Rinon.cl",
  description: "Camarote con escritorio con despacho a Vitacura. Modelos económico, estándar y full. Fabricación directa en Chile, pago contra entrega en Santiago RM.",
  keywords: ["camarote con escritorio Vitacura", "cama alta con escritorio Vitacura", "camarote escritorio Vitacura", "camarote con escritorio vitacura despacho"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-vitacura" },
};
...
const VECINAS = [
  ...
  { href: "/camarote-con-escritorio-providencia", nombre: "Providencia" },
  { href: "/camarote-con-escritorio-huechuraba", nombre: "Huechuraba" },
];

const FAQ = [
  {
    q: "¿Hacen despacho de camarotes con escritorio a Vitacura?",
    a: "Sí. Despachamos e instalamos camarotes con escritorio en Vitacura y en toda la Región Metropolitana. En Santiago RM el pago es contra entrega: pagas cuando el producto llega a tu domicilio."
  },
  {
    q: "¿Cuánto demora el despacho a Vitacura?",
  ...
  {
    q: "¿Tienen camarotes con escritorio en stock para Vitacura?",
    a: "Consulta disponibilidad actual directamente por WhatsApp y te confirmamos el modelo y el plazo para Vitacura."
  }
];

export default function CamaroteEscritorioVitacuraPage() {
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Vitacura. ¿Qué modelos tienen?");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Vitacura", item: "https://rinon.cl/camarote-con-escritorio-vitacura" },
        ],
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Camarote con escritorio con despacho a Vitacura</h1>

        <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mb-4">En Vitacura el camarote con escritorio es buscado para dormitorios de jóvenes que requieren un espacio de estudio sin renunciar a la comodidad.</p>
        <p className="text-gray-500 leading-relaxed max-w-2xl mb-8">
          Fabricamos en acero en nuestro propio taller y despachamos a Vitacura y sectores como Alonso de Córdova, Los Militares, Bicentenario.
        ...
        <div className="my-6 rounded-2xl overflow-hidden shadow-sm max-w-xl">
          <img src="/images/camarotes/camarote-escritorio-2-plazas-productividad.jpg" alt="Camarote con escritorio con despacho a Vitacura, Región Metropolitana" className="w-full object-cover" loading="lazy" />
        </div>
        ...
        {/* FAQ */}
        <div className="mt-12">
          <h2 className="text-xl font-bold text-gray-900 mb-5">Preguntas frecuentes — Vitacura</h2>
        ...
        <div className="mt-12 bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Cotizar en Vitacura</h2>
