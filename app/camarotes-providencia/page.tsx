      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <img src="/images/camarotes/camarote-escritorio-full-productividad.jpg" alt="Camarote escritorio full Providencia — máxima productividad" className="w-full object-cover" loading="lazy" />
          </div>
<a
