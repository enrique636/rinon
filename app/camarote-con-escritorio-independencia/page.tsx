...
export const metadata: Metadata = {
  title: "Camarote con Escritorio en Independencia — Fabricación directa | Rinon.cl",
  description: "Camarote con escritorio con despacho a Independencia. Modelos económico, estándar y full. Fabricación directa en Chile, pago contra entrega en Santiago RM.",
  keywords: ["camarote con escritorio Independencia", "cama alta con escritorio Independencia", "camarote escritorio Independencia", "camarote con escritorio independencia despacho"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-independencia" },
};
...
const VECINAS = [
  { href: "/camarote-con-escritorio-santiago", nombre: "Santiago" },
  { href: "/camarote-con-escritorio-recoleta", nombre: "Recoleta" },
  { href: "/camarote-con-escritorio-huechuraba", nombre: "Huechuraba" },
];

const FAQ = [
  {
    q: "¿Hacen despacho de camarotes con escritorio a Independencia?",
    a: "Sí. Despachamos e instalamos camarotes con escritorio en Independencia y en toda la Región Metropolitana. En Santiago RM el pago es contra entrega: pagas cuando el producto llega a tu domicilio."
  },
  {
    q: "¿Cuánto demora el despacho a Independencia?",
  ...
  {
    q: "¿Tienen camarotes con escritorio en stock para Independencia?",
    a: "Consulta disponibilidad actual directamente por WhatsApp y te confirmamos el modelo y el plazo para Independencia."
  }
];

export default function CamaroteEscritorioIndependenciaPage() {
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Independencia. ¿Qué modelos tienen?");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Independencia", item: "https://rinon.cl/camarote-con-escritorio-independencia" },
        ],
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-1.5 text-sm text-green-700 font-medium mb-5">
          <span className="w-2 h-2 bg-green-500 rounded-full" /> Despacho a Independencia · Pago contra entrega
        </div>

        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Camarote con escritorio con despacho a Independencia</h1>

        <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mb-4">Independencia alberga varias universidades y una población estudiantil numerosa que busca soluciones para piezas pequeñas con espacio de estudio integrado.</p>
        <p className="text-gray-500 leading-relaxed max-w-2xl mb-8">
          Fabricamos en acero en nuestro propio taller y despachamos a Independencia y sectores como Dominica, Vivaceta, Avenida Independencia.
        ...
        <div className="my-6 rounded-2xl overflow-hidden shadow-sm max-w-xl">
          <img src="/images/camarotes/camarote-escritorio-2-plazas-productividad.jpg" alt="Camarote con escritorio con despacho a Independencia, Región Metropolitana" className="w-full object-cover" loading="lazy" />
        </div>
        ...
        {/* FAQ */}
        <div className="mt-12">
          <h2 className="text-xl font-bold text-gray-900 mb-5">Preguntas frecuentes — Independencia</h2>
        ...
        <div className="mt-12 bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Cotizar en Independencia</h2>
