...
export default function RejasMetalicasLaFloridaPage() {
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Fabrican e instalan rejas metálicas en La Florida?", acceptedAnswer: { "@type": "Answer", text: "Sí. Fabricamos e instalamos rejas metálicas en La Florida. Cotizamos el mismo día — necesitamos el ancho y alto del frente, más si incluye portón. Pintamos al horno para mayor durabilidad." } },
