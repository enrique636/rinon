      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <img src="/images/camarotes/camarote-desmontable-juvenil.jpg" alt="Camarote desmontable juvenil Renca — fabricante directo Santiago" className="w-full object-cover" loading="lazy" />
          </div>
