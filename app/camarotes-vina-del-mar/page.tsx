...
export default function CamarotesVinaDelMarPage() {
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes a Viña del Mar?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos camarotes metálicos a Viña del Mar. Para Santiago RM el despacho incluye instalación. Para regiones coordinamos transporte al cotizar — solo necesitamos la dirección." } },
