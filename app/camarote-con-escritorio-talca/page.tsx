...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Talca | Región del Maule",
  description: "Camarotes metálicos con escritorio con despacho a Talca y la Región del Maule. Fabricante en Santiago. Envío en 3-6 días hábiles a tu domicilio en Talca.",
  keywords: ["camarote con escritorio talca", "litera escritorio talca", "cama alta escritorio talca", "camarote maule escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-talca" },
};

export default function Page() {
  const ciudad = "Talca";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Talca.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y toda la VII Región del Maule vía transporte terrestre. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad} es de aproximadamente 3-6 días hábiles dependiendo del servicio de transporte disponible en tu zona.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la VII Región del Maule. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas. Tiempo estimado de entrega: 3-6 días hábiles.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la VII Región del Maule vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
            { q: "¿Cuánto demora el envío?", a: `El tiempo de despacho a ${ciudad} es de aproximadamente 3-6 días hábiles.` },
