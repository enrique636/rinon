      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <img src="/images/camarotes/camarote-escritorio-economico-universitario.jpg" alt="Camarote con escritorio para universitario — piezas pequeñas Santiago" className="w-full object-cover" loading="lazy" />
          </div>
