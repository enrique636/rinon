...
export default function CamarotesSierraGordaPage() {
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes a en Sierra Gorda?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos camarotes metálicos a en Sierra Gorda. Para Santiago RM el despacho incluye instalación. Para regiones coordinamos transporte al cotizar — solo necesitamos la dirección." } },
...
<div className="max-w-4xl mx-auto">
        ...
        <div className="flex gap-3 flex-wrap mb-10">
            ...
            <img src="/images/camarotes/camarote-triple-campamento-construccion.jpg" alt="Camarote triple para campamento construcción Sierra Gorda" className="w-full object-cover" loading="lazy" />
          </div>
