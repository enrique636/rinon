      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          {topProducts.map(product => (
            ...
            <img src="/images/camarotes/camarote-escritorio-full-dormitorio-completo.jpg" alt="Camarote escritorio full Vitacura — dormitorio oficina completo" className="w-full object-cover" loading="lazy" />
          </div>
