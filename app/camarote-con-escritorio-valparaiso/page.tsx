...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Valparaíso | V Región",
  description: "Camarotes metálicos con escritorio con despacho a Valparaíso. Fabricante directo en Santiago, envío a la V Región. Tiempo de entrega 2-5 días hábiles.",
  keywords: ["camarote con escritorio valparaiso", "litera escritorio valparaiso", "cama alta escritorio valparaiso", "camarote valparaiso chile"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-valparaiso" },
};

export default function Page() {
  const ciudad = "Valparaíso";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Valparaíso.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y toda la V Región (Viña del Mar, Quilpué, Villa Alemana) vía transporte terrestre. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad} es de aproximadamente 2-5 días hábiles por su cercanía con Santiago.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la V Región (Viña del Mar, Quilpué, Villa Alemana) vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
            { q: "¿Cuánto demora el envío?", a: `El tiempo de despacho a ${ciudad} es de aproximadamente 2-5 días hábiles.` },
