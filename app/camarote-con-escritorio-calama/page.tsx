...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Calama | Norte Minero",
  description: "Camarotes metálicos con escritorio con despacho a Calama. Norte minero de Chile. Residencial y uso intensivo. Fabricante directo en Santiago, envío al norte.",
  keywords: ["camarote con escritorio calama", "litera escritorio calama", "cama alta escritorio calama", "camarote norte minero escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-calama" },
};

export default function Page() {
  const ciudad = "Calama";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Calama.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} vía transporte terrestre, en el norte minero de Chile. También llegamos a Antofagasta y San Pedro de Atacama. El camarote se envía desarmado en cajas protegidas.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en el norte minero de Chile. Camarotes metálicos con escritorio integrado, ideales para uso residencial e intensivo, enviados desarmados en cajas protegidas. También atendemos Antofagasta y San Pedro de Atacama. Tiempo estimado de entrega: 5-10 días hábiles.</p>
        ...
        <div className="space-y-4 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { icon: "📦", t: "Empacamos y despachamos", d: "El camarote sale de nuestro taller en Santiago empacado para transporte. Se envía vía transporte terrestre al norte minero." },
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad}, Antofagasta y San Pedro de Atacama vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
