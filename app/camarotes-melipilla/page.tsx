...
export default function CamarotesMelipillaPage() {
  ...
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes a en Melipilla?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos camarotes metálicos a en Melipilla. Para Santiago RM el despacho incluye instalación. Para regiones coordinamos transporte al cotizar — solo necesitamos la dirección." } },
...
<div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          {topProducts.map(product => (
            ...
            <img src="/images/camarotes/camarote-triple-campamento-agricola.jpg" alt="Camarote triple agrícola Melipilla — fundos y faenas Maipo" className="w-full object-cover" loading="lazy" />
          </div>
