...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Osorno | Los Lagos",
  description: "Camarotes metálicos con escritorio con despacho a Osorno y la Región de Los Lagos. Fabricante en Santiago. Envío sur de Chile, entrega estimada 7-10 días.",
  keywords: ["camarote con escritorio osorno", "litera escritorio osorno", "cama alta escritorio osorno", "camarote los lagos escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-osorno" },
};

export default function Page() {
  const ciudad = "Osorno";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Osorno.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y la Región de Los Lagos vía transporte terrestre, en el sur de Chile. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad}, en el sur de Chile, es de aproximadamente 7-10 días hábiles dependiendo del servicio de transporte disponible en tu zona.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la Región de Los Lagos. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas al sur del país. Tiempo estimado de entrega: 7-10 días hábiles.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la Región de Los Lagos vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
            { q: "¿Cuánto demora el envío?", a: `El tiempo de despacho a ${ciudad} es de aproximadamente 7-10 días hábiles.` },
