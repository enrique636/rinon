...
export default function CamaroteEscritorioPenalolenPage() {
  ...
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes con escritorio a Peñalolén?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos e instalamos camarotes con escritorio en Peñalolén con un costo fijo que incluye instalación. Pagas cuando llega el producto a tu domicilio." } },
