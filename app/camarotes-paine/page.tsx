...
export default function CamarotesPainePage() {
  ...
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes a para Paine?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos camarotes metálicos a para Paine. Para Santiago RM el despacho incluye instalación. Para regiones coordinamos transporte al cotizar — solo necesitamos la dirección." } },
...
<div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <img src="/images/camarotes/camarote-metalico-habitacion-pequena.jpg" alt="Camarote metálico Paine — aprovecha el espacio vertical" className="w-full object-cover" loading="lazy" />
          </div>
