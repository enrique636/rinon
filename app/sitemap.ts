...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    // === BATCH 45 — rejas más ciudades nacionales + camarote-2-plazas + portones-santiago ===
    { url: `${BASE_URL}/rejas-metalicas-la-serena`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/rejas-metalicas-rancagua`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/rejas-metalicas-talca`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/rejas-metalicas-puerto-montt`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/rejas-metalicas-iquique`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/rejas-metalicas-arica`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/rejas-metalicas-vina-del-mar`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.87 },
    { url: `${BASE_URL}/rejas-metalicas-chillan`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/camarote-2-plazas`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.91 },
    { url: `${BASE_URL}/cercos-perimetrales-vina-del-mar`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/portones-santiago`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.90 },
    { url: `${BASE_URL}/portones-concepcion`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.88 },
    ...
    // === BATCH 48 — Fabricante directo (todas las líneas) ===
    { url: `${BASE_URL}/fabricante-cierres-perimetrales`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.93 },
    { url: `${BASE_URL}/fabricante-rejas-metalicas-chile`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.93 },
    { url: `${BASE_URL}/fabricante-portones-metalicos-chile`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.93 },
    { url: `${BASE_URL}/fabricante-estructuras-metalicas-chile`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.92 },
    { url: `${BASE_URL}/camarotes-metalicos-fabricante-directo`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.92 },
    { url: `${BASE_URL}/metalurgica-rinon`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.90 },
    // === BATCH 49 — Cierres perimetrales B2B ===
    { url: `${BASE_URL}/cierres-perimetrales-por-mayor`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.91 },
    { url: `${BASE_URL}/cierres-perimetrales-para-empresas`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.91 },
    { url: `${BASE_URL}/proveedor-cierres-perimetrales`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.90 },
    { url: `${BASE_URL}/cierres-metalicos-industriales`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.90 },
    { url: `${BASE_URL}/presupuesto-cierre-perimetral`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.92 },
    // === BATCH 50 — Pintura electrostática zona sur ===
    { url: `${BASE_URL}/pintura-electrostatica-zona-sur-santiago`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.88 },
    { url: `${BASE_URL}/pintura-electrostatica-buin`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.83 },
    { url: `${BASE_URL}/pintura-electrostatica-paine`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE_URL}/pintura-electrostatica-calera-de-tango`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE_URL}/pintura-electrostatica-talagante`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    // === BATCH 51 — Camarotes fabricante y mayorista ===
    { url: `${BASE_URL}/camarotes-precio-mayorista`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.92 },
    { url: `${BASE_URL}/camarotes-fabricante-santiago`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.92 },
    { url: `${BASE_URL}/venta-mayor-camarotes-metalicos`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.91 },
    { url: `${BASE_URL}/camarotes-metalicos-precio-fabrica`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.91 },
    { url: `${BASE_URL}/camarotes-industriales`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.90 },
    { url: `${BASE_URL}/camarotes-acero-chile`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.90 },
    // === BATCH 52 — Camarote con escritorio variantes ===
    { url: `${BASE_URL}/camarote-con-escritorio-adulto`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.88 },
    { url: `${BASE_URL}/camarote-con-escritorio-plaza-y-media`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.87 },
    { url: `${BASE_URL}/litera-con-escritorio`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.88 },
    { url: `${BASE_URL}/cama-loft-con-escritorio`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.88 },
    { url: `${BASE_URL}/camarote-con-escritorio-y-estantes`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.87 },
    { url: `${BASE_URL}/camarote-con-escritorio-desmontable`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.87 },
    { url: `${BASE_URL}/camarote-con-escritorio-negro`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/camarote-con-escritorio-blanco`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/camarote-con-escritorio-resistente`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/camarote-con-escritorio-setup-gaming`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    // === BATCH 53 — Camarote con escritorio por perfil ===
    { url: `${BASE_URL}/camarote-con-escritorio-teletrabajo`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.87 },
    { url: `${BASE_URL}/camarote-con-escritorio-paes`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/camarote-con-escritorio-internado`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/camarote-con-escritorio-dormitorio-compartido`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/camarote-con-escritorio-monoambiente`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/camarote-con-escritorio-hostal`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.86 },
    { url: `${BASE_URL}/camarote-con-escritorio-medico-residente`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/camarote-con-escritorio-musico`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.84 },
    // === BATCH 54 — Camarote con escritorio ciudades regiones ===
    { url: `${BASE_URL}/camarote-con-escritorio-antofagasta`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.84 },
    { url: `${BASE_URL}/camarote-con-escritorio-valparaiso`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.84 },
    { url: `${BASE_URL}/camarote-con-escritorio-concepcion`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.84 },
    { url: `${BASE_URL}/camarote-con-escritorio-rancagua`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.83 },
    { url: `${BASE_URL}/camarote-con-escritorio-temuco`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.83 },
    { url: `${BASE_URL}/camarote-con-escritorio-la-serena`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.83 },
    { url: `${BASE_URL}/camarote-con-escritorio-iquique`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.83 },
    { url: `${BASE_URL}/camarote-con-escritorio-vina-del-mar`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.83 },
    { url: `${BASE_URL}/camarote-con-escritorio-talca`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE_URL}/camarote-con-escritorio-arica`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE_URL}/camarote-con-escritorio-copiapo`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE_URL}/camarote-con-escritorio-osorno`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE_URL}/camarote-con-escritorio-puerto-montt`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE_URL}/camarote-con-escritorio-calama`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE_URL}/camarote-con-escritorio-chillan`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.81 },
    // === BATCH 55 — Camarotes con escritorio mayorista/precio ===
    { url: `${BASE_URL}/camarotes-con-escritorio-precio-fabrica`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.90 },
    { url: `${BASE_URL}/camarotes-con-escritorio-por-mayor`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.90 },
