...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Puerto Montt | X Región",
  description: "Camarotes metálicos con escritorio con despacho a Puerto Montt y la X Región de Los Lagos. Fabricante en Santiago. Envío al sur, cotiza con anticipación.",
  keywords: ["camarote con escritorio puerto montt", "litera escritorio puerto montt", "cama alta escritorio puerto montt", "camarote chile sur escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-puerto-montt" },
};

export default function Page() {
  const ciudad = "Puerto Montt";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Puerto Montt.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y la X Región de Los Lagos vía transporte terrestre, en el sur de Chile. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad}, en el sur de Chile, es de aproximadamente 7-12 días hábiles. Te recomendamos cotizar con anticipación.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la X Región de Los Lagos. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas al sur del país. Tiempo estimado de entrega: 7-12 días hábiles.</p>
        ...
        <div className="space-y-4 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { icon: "💬", t: "Cotiza por WhatsApp", d: `Dinos tu modelo y dirección en ${ciudad}. Te confirmamos disponibilidad y costo de despacho al sur.` },
              { icon: "📦", t: "Empacamos y despachamos", d: "El camarote sale de nuestro taller en Santiago empacado para transporte. Se envía vía transporte terrestre al sur." },
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la X Región de Los Lagos vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
