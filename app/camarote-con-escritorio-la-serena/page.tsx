...
export const metadata: Metadata = {
  title: "Camarote con Escritorio La Serena | IV Región",
  description: "Camarotes metálicos con escritorio con despacho a La Serena y Coquimbo. Fabricante en Santiago. Envío al norte chico, tiempo estimado 3-7 días hábiles.",
  keywords: ["camarote con escritorio la serena", "litera escritorio la serena", "cama alta escritorio la serena", "camarote coquimbo escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-la-serena" },
};

export default function Page() {
  const ciudad = "La Serena";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a La Serena.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y toda la IV Región de Coquimbo (Coquimbo, Ovalle) vía transporte terrestre. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad}, en el norte chico, es de aproximadamente 3-7 días hábiles dependiendo del servicio de transporte disponible en tu zona.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la IV Región de Coquimbo. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas al norte chico. También llegamos a Coquimbo y Ovalle. Tiempo estimado de entrega: 3-7 días hábiles.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad}, Coquimbo y Ovalle en la IV Región vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
            { q: "¿Cuánto demora el envío?", a: `El tiempo de despacho a ${ciudad} es de aproximadamente 3-7 días hábiles.` },
