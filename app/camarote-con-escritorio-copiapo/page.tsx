...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Copiapó | III Región",
  description: "Camarotes metálicos con escritorio con despacho a Copiapó y la III Región de Atacama. Fabricante en Santiago. Envío norte minero, entrega 5-8 días hábiles.",
  keywords: ["camarote con escritorio copiapo", "litera escritorio copiapo", "cama alta escritorio copiapo", "camarote atacama escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-copiapo" },
};

export default function Page() {
  const ciudad = "Copiapó";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Copiapó.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y toda la III Región de Atacama vía transporte terrestre, en el norte minero de Chile. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad}, en el norte de Chile, es de aproximadamente 5-8 días hábiles dependiendo del servicio de transporte disponible en tu zona.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la III Región de Atacama. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas al norte minero. Tiempo estimado de entrega: 5-8 días hábiles.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la III Región de Atacama vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
            { q: "¿Cuánto demora el envío?", a: `El tiempo de despacho a ${ciudad} es de aproximadamente 5-8 días hábiles.` },
