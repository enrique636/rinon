...
<div className="max-w-4xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-1.5 text-sm text-green-700 font-medium mb-5">
          <span className="w-2 h-2 bg-green-500 rounded-full" /> Despacho a Maipú · Pago contra entrega
        </div>
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Camarote con Escritorio en Maipú</h1>
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Despacho e instalación en Maipú. Pago cuando llega instalado. Despacho {formatPrice(SITE_CONFIG.despacho.precio)}.</p>
        ...
        <div className="bg-green-50 border border-green-200 rounded-2xl p-6 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Cotizar en Maipú</h2>
          ...
          <div className="my-5 rounded-2xl overflow-hidden shadow-sm">
            <img src="/images/camarotes/camarote-escritorio-full-productividad.jpg" alt="Camarote con escritorio con despacho a Maipú Santiago" className="w-full object-cover" loading="lazy" />
          </div>
