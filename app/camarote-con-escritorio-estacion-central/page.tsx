...
export default function CamaroteEscritorioEstacionCentralPage() {
  ...
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes con escritorio a Estación Central?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos e instalamos camarotes con escritorio en Estación Central con un costo fijo que incluye instalación. Pagas cuando llega el producto a tu domicilio." } },
...
<div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="my-5 rounded-2xl overflow-hidden shadow-sm">
            <img src="/images/camarotes/camarote-escritorio-economico-dormitorio.jpg" alt="Camarote con escritorio con despacho a Estación Central Santiago" className="w-full object-cover" loading="lazy" />
          </div>
