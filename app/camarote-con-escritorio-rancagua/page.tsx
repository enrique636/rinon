...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Rancagua | O'Higgins",
  description: "Camarotes metálicos con escritorio con despacho a Rancagua y la VI Región de O'Higgins. Fabricante en Santiago. Entrega en 2-4 días hábiles.",
  keywords: ["camarote con escritorio rancagua", "litera escritorio rancagua", "cama alta escritorio rancagua", "camarote region ohiggins"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-rancagua" },
};

export default function Page() {
  const ciudad = "Rancagua";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Rancagua.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y la VI Región de O'Higgins vía transporte terrestre. El camarote se envía desarmado en cajas protegidas.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la VI Región de O'Higgins. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas. Por la cercanía con la capital, el tiempo estimado de entrega es de 2-4 días hábiles.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la VI Región de O'Higgins vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
