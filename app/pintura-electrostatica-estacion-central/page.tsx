...
export default function PinturaElectrostaticaEstacionCentralPage() {
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen pintura electrostática al horno en Estación Central?", acceptedAnswer: { "@type": "Answer", text: "Sí. Realizamos servicio de pintura electrostática al horno para rejas, portones, estructuras y piezas metálicas en Estación Central. El proceso incluye arenado o fosfatado, aplicación del polvo y horneado para un acabado duradero." } },
