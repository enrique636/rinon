...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Iquique | I Región Chile",
  description: "Camarotes metálicos con escritorio con despacho a Iquique y la I Región de Tarapacá. Fabricante en Santiago. Envío al extremo norte.",
  keywords: ["camarote con escritorio iquique", "litera escritorio iquique", "cama alta escritorio iquique", "camarote tarapaca escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-iquique" },
};

export default function Page() {
  const ciudad = "Iquique";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Iquique.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y la I Región de Tarapacá vía transporte terrestre, al extremo norte de Chile. El camarote se envía desarmado en cajas protegidas.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la I Región de Tarapacá. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas al extremo norte del país. Tiempo estimado de entrega: 7-12 días hábiles.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la I Región de Tarapacá vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
