...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Temuco | La Araucanía",
  description: "Camarotes metálicos con escritorio con despacho a Temuco y La Araucanía. Fabricante en Santiago. Envío desarmado para que lo armes en casa.",
  keywords: ["camarote con escritorio temuco", "litera escritorio temuco", "cama alta escritorio temuco", "camarote araucania escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-temuco" },
};

export default function Page() {
  const ciudad = "Temuco";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Temuco.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y toda la IX Región de La Araucanía vía transporte terrestre. El camarote se envía desarmado en cajas protegidas para que lo armes en casa.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad}, en el sur de Chile, es de aproximadamente 5-10 días hábiles dependiendo del servicio de transporte disponible en tu zona.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la IX Región de La Araucanía. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas al sur del país. Tiempo estimado de entrega: 5-10 días hábiles.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la IX Región de La Araucanía vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
