...
export const metadata: Metadata = {
  title: "Reja Metálica El Bosque — Fabricante con Instalación | Sur RM",
  description: "Rejas metálicas en El Bosque. Fabricante directo con instalación incluida. Frontis de casa, portón vehicular y puerta peatonal para el sector sur de Santiago.",
  keywords: [
    "reja metalica el bosque",
    "rejas metalicas el bosque",
    "reja para casa el bosque santiago",
    "portones el bosque",
    "cerco el bosque santiago",
    "fabricante rejas el bosque",
    "reja de fierro el bosque",
...
export default function RejasMetalicasElBosquePage() {
  return (
    <div className="py-12 px-4">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "¿Fabrican e instalan rejas metálicas en El Bosque?", acceptedAnswer: { "@type": "Answer", text: "Sí. Fabricamos e instalamos rejas metálicas en El Bosque. Cotizamos el mismo día — necesitamos el ancho y alto del frente, más si incluye portón. Pintamos al horno para mayor durabilidad." } },
...
<div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Rejas Metálicas en El Bosque — Sur de Santiago
          </h1>
          <p className="text-gray-500 text-lg max-w-2xl mb-6 leading-relaxed">
            Fabricamos e instalamos rejas metálicas en El Bosque y el sector sur de Santiago.
            Frontis de casa, portón vehicular y puerta peatonal — a medida, con pintura
            electrostática al horno. Instalación con garantía.
          </p>
          <a
            href={wa("Hola, necesito cotizar una reja metálica en El Bosque. Metros del frontis: [METROS] ml. Altura: [ALTURA] m. Con portón vehicular: [SÍ / NO].")}
            target="_blank"
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-wrap gap-2">
            {["El Bosque","San Bernardo Sur","La Cisterna Norte","Pedro Aguirre Cerda Sur",
              "Lo Espejo Norte","San Ramón Oriente","Villa El Bosque",
              "El Almendral","Av. La Serena Oriente"].map((s) => (
        ...
        <div className="bg-gray-900 rounded-2xl p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-2">Cotiza tu reja en El Bosque hoy</h2>
          <p className="text-gray-400 text-sm mb-5">
            Metros del frontis, altura y si lleva portón. Respondemos el mismo día.
          </p>
          <a
            href={wa("Hola, necesito reja metálica en El Bosque. Metros: [METROS] ml. Altura: [ALTURA] m. Con portón: [SÍ / NO].")}
