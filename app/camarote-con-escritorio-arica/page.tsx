...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Arica | Extremo Norte",
  description: "Camarotes metálicos con escritorio con despacho a Arica. Fabricante en Santiago, envío al extremo norte de Chile. Cotiza por WhatsApp, tiempo de entrega 7-12 días.",
  keywords: ["camarote con escritorio arica", "litera escritorio arica", "cama alta escritorio arica", "camarote norte extremo chile escritorio"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-arica" },
};

export default function Page() {
  const ciudad = "Arica";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Arica.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y la Región de Arica y Parinacota vía transporte terrestre, en el extremo norte de Chile. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad}, en el extremo norte, es de aproximadamente 7-12 días hábiles dependiendo del servicio de transporte disponible en tu zona.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en el extremo norte de Chile (Región de Arica y Parinacota). Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas. Tiempo estimado de entrega: 7-12 días hábiles.</p>
        ...
        <div className="space-y-4 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { icon: "📦", t: "Empacamos y despachamos", d: "El camarote sale de nuestro taller en Santiago empacado para transporte. Se envía vía transporte terrestre al extremo norte." },
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la Región de Arica y Parinacota vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
            { q: "¿Cuánto demora el envío?", a: `El tiempo de despacho a ${ciudad} es de aproximadamente 7-12 días hábiles.` },
