...
export default function CamarotesLosAngelesPage() {
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes a en Los Ángeles?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos camarotes metálicos a en Los Ángeles. Para Santiago RM el despacho incluye instalación. Para regiones coordinamos transporte al cotizar — solo necesitamos la dirección." } },
