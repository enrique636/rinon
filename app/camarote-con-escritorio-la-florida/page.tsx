...
export default function CamaroteEscritorioLaFloridaPage() {
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a La Florida. ¿Qué modelos tienen?");
  return (
    <div className="py-12 px-4">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes con escritorio a La Florida?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos e instalamos camarotes con escritorio en La Florida con un costo fijo que incluye instalación. Pagas cuando llega el producto a tu domicilio." } },
...
<div className="max-w-4xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-1.5 text-sm text-green-700 font-medium mb-5">
          <span className="w-2 h-2 bg-green-500 rounded-full" /> Despacho a La Florida · Pago contra entrega
        </div>
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Camarote con Escritorio en La Florida</h1>
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Despacho e instalación en La Florida. Pago cuando llega instalado. Despacho {formatPrice(SITE_CONFIG.despacho.precio)}.</p>
