...
export const metadata: Metadata = {
  title: "Camarote con Escritorio en Macul — Fabricación directa | Rinon.cl",
  description: "Camarote con escritorio con despacho a Macul. Modelos económico, estándar y full. Fabricación directa en Chile, pago contra entrega en Santiago RM.",
  keywords: ["camarote con escritorio Macul", "cama alta con escritorio Macul", "camarote escritorio Macul", "camarote con escritorio macul despacho"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-macul" },
};
...
const VECINAS = [
  ...
  { href: "/camarote-con-escritorio-la-florida", nombre: "La Florida" },
  { href: "/camarote-con-escritorio-penalolen", nombre: "Peñalolén" },
];

const FAQ = [
  {
    q: "¿Hacen despacho de camarotes con escritorio a Macul?",
    a: "Sí. Despachamos e instalamos camarotes con escritorio en Macul y en toda la Región Metropolitana. En Santiago RM el pago es contra entrega: pagas cuando el producto llega a tu domicilio."
  },
  {
    q: "¿Cuánto demora el despacho a Macul?",
  ...
  {
    q: "¿Tienen camarotes con escritorio en stock para Macul?",
    a: "Consulta disponibilidad actual directamente por WhatsApp y te confirmamos el modelo y el plazo para Macul."
  }
];

export default function CamaroteEscritorioMaculPage() {
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Macul. ¿Qué modelos tienen?");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Macul", item: "https://rinon.cl/camarote-con-escritorio-macul" },
        ],
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Camarote con escritorio con despacho a Macul</h1>

        <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mb-4">Macul tiene una mezcla de casas familiares y departamentos donde los camarotes con escritorio son solicitados especialmente para habitaciones de jóvenes estudiantes.</p>
        <p className="text-gray-500 leading-relaxed max-w-2xl mb-8">
          Fabricamos en acero en nuestro propio taller y despachamos a Macul y sectores como Grecia, Departamental, Los Graneros.
        ...
        <div className="my-6 rounded-2xl overflow-hidden shadow-sm max-w-xl">
          <img src="/images/camarotes/camarote-escritorio-2-plazas-productividad.jpg" alt="Camarote con escritorio con despacho a Macul, Región Metropolitana" className="w-full object-cover" loading="lazy" />
        </div>
        ...
        {/* FAQ */}
        <div className="mt-12">
          <h2 className="text-xl font-bold text-gray-900 mb-5">Preguntas frecuentes — Macul</h2>
        ...
        <div className="mt-12 bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Cotizar en Macul</h2>
