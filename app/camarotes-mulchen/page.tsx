...
export default function CamarotesMulchenPage() {
  ...
  return (
    <div className="py-12 px-4">
        ...
        mainEntity: [
          { "@type": "Question", name: "¿Hacen despacho de camarotes a Mulchén?", acceptedAnswer: { "@type": "Answer", text: "Sí. Despachamos camarotes metálicos a Mulchén. Para Santiago RM el despacho incluye instalación. Para regiones coordinamos transporte al cotizar — solo necesitamos la dirección." } },
...
<div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <img src="/images/camarotes/camarote-triple-faena-forestal.jpg" alt="Camarote triple metálico Mulchén — faenas forestales Biobío" className="w-full object-cover" loading="lazy" />
          </div>
