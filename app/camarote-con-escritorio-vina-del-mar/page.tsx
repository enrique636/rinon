...
export const metadata: Metadata = {
  title: "Camarote con Escritorio Viña del Mar | V Región",
  description: "Camarotes metálicos con escritorio con despacho a Viña del Mar. Fabricante en Santiago. Envío a la V Región, entrega en 2-4 días hábiles a tu domicilio.",
  keywords: ["camarote con escritorio vina del mar", "litera escritorio vina del mar", "cama alta escritorio vina del mar", "camarote escritorio valparaiso region"],
  alternates: { canonical: "https://rinon.cl/camarote-con-escritorio-vina-del-mar" },
};

export default function Page() {
  const ciudad = "Viña del Mar";
  const wa = getWhatsAppUrl("Hola, quiero cotizar un camarote con escritorio con despacho a Viña del Mar.");
  return (
    <div className="py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org", "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: `¿Hacen despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `Sí. Despachamos a ${ciudad} y toda la V Región de Valparaíso vía transporte terrestre. El camarote se envía desarmado en cajas protegidas.` } },
          { "@type": "Question", name: `¿Cuánto demora el despacho a ${ciudad}?`, acceptedAnswer: { "@type": "Answer", text: `El tiempo de despacho a ${ciudad} es de aproximadamente 2-4 días hábiles por su cercanía con Santiago.` } },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-lg max-w-2xl mb-6">Fabricamos en Santiago y despachamos a {ciudad}, en la V Región de Valparaíso. Camarotes metálicos con escritorio integrado, enviados desarmados en cajas protegidas. Por la cercanía con la capital, el tiempo estimado de entrega es de 2-4 días hábiles. ¿Vives en la ciudad vecina? También despachamos a <Link href="/camarote-con-escritorio-valparaiso" className="text-green-600 underline">Valparaíso</Link>.</p>
        ...
        <div className="space-y-3 mb-10">
          ...
          {[
            { q: `¿Hacen despacho a ${ciudad}?`, a: `Sí. Despachamos a ${ciudad} y la V Región de Valparaíso vía transporte terrestre. El camarote llega desarmado en cajas protegidas.` },
            { q: "¿Cuánto demora el envío?", a: `El tiempo de despacho a ${ciudad} es de aproximadamente 2-4 días hábiles.` },
