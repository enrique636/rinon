              ...
              <div key={product.id} className="bg-white border border-gray-200 rounded-xl p-5 hover:border-gray-400 hover:shadow-sm transition-all flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex gap-2">
                    <div className="my-5 rounded-2xl overflow-hidden shadow-sm"><img src="/images/camarotes/camarote-desmontable-negro-fondo-blanco.jpg" alt="Camarote metálico Pudahuel Santiago — entrega zona poniente" className="w-full object-cover" loading="lazy" /></div>
