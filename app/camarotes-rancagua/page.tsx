      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <img src="/images/camarotes/camarote-faenero-campamento-construccion.jpg" alt="Camarote faenero construcción Rancagua — El Teniente y zona minera" className="w-full object-cover" loading="lazy" />
          </div>
